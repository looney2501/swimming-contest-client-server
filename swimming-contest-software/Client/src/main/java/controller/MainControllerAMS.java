...
public class MainControllerAMS extends ControllerAMS implements NotificationSubscriber {
    @FXML
    ...
    public MainControllerAMS(SwimmingRaceServicesAMS service, NotificationReceiver notificationReceiver) {
        super(service);
    ...
    public void notificationReceived(Notification notification) {
        logger.traceEntry("Notification received...");
        try {
            if (notification.getNotificationType() == NotificationType.RACES_UPDATED) {
                Platform.runLater(this::updateModels);
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        }
