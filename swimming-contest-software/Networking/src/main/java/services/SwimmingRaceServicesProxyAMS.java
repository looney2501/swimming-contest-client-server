...
public class SwimmingRaceServicesProxyAMS implements SwimmingRaceServicesAMS {
    ...
    public SwimmingRaceServicesProxyAMS(String host, int port) {
        this.host = host;
        this.port = port;
    ...
    private void startReader() {
        Thread tw = new Thread(new SwimmingRaceServicesProxyAMS.ReaderThread());
