...
public class SwimmingRaceClientWorkerAMS implements Runnable {
    ...
    public SwimmingRaceClientWorkerAMS(SwimmingRaceServicesAMS services, Socket clientSocket) {
    ...
    private Response handleRequest(Request request) {
        if (request instanceof LoginRequest loginRequest) {
            ...
            try {
                services.login(adminDTO.getUsername(), adminDTO.getPassword());
